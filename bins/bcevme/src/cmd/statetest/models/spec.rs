...
impl SpecName {
    pub fn to_spec_id(&self) -> SpecId {
        match self {
            ...
            Self::EIP150 | Self::HomesteadToDaoAt5 | Self::HomesteadToEIP150At5 => SpecId::TANGERINE,
            ...
            Self::ByzantiumToConstantinopleAt5 | Self::Constantinople => panic!("Overridden with PETERSBURG"),
