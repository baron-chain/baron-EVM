use bcevm::primitives::{Address, Bytes, HashMap, B256, U256};
...
mod tests {
    ...
    #[test]
    fn serialize_u256() -> Result<(), Error> {
        let json = r#"{"_item":"0x10"}"#;
        #[derive(Deserialize, Debug)]
        struct Test { _item: Option<U256> }
    ...
    #[test]
    fn deserialize_minimal_transaction_parts() -> Result<(), Error> {
