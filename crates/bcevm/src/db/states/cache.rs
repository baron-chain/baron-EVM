...
///
/// Cache state is main state that bcevm uses to access state.
/// It loads all accounts from database and applies bcevm output to it.
///
...
impl CacheState {
    ...
    /// Apply output of bcevm execution and create account transitions that are used to build BundleState.
    ...
    fn apply_account_state(
        ...
        // If it is marked as selfdestructed inside bcevm
